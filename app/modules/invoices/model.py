...
class InvoiceLineItem(MyAbstractSQLModel, table=True):
    ...
    # e.g "On Solar Energy Supplied", "Off-Solar Energy Supplied",
    # "Fixed Asset Lease", "Monthly Maintenance Fee"
    ...
    tariff_period: Optional[int] = Field(nullable=True)  # which tariff period was active
